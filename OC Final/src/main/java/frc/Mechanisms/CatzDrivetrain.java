...
public class CatzDrivetrain 
{
    ...
    private final double LT_FRNT_OFFSET =  0.0100;
    ...
    public void dataCollection()
    {
        ...
        {
            data = new CatzLog(Robot.currentTime.get(), dataJoystickPower, dataJoystickAngle,
                                                        LT_FRNT_MODULE.getAngle(), LT_FRNT_MODULE.getDrvDistance(), LT_FRNT_MODULE.getDrvVelocity(),
                                                        -999.0,-999.0,-999.0,-999.0,-999.0,-999.0,-999.0-999.0,-999.0,-999.0, DataCollection.boolData);  
            Robot.dataCollection.logData.add(data);
        }
    }
